...
import com.sap.marmolata.react.debug.InternalStrictMap
import com.sap.marmolata.react.impls.selfrx
import com.sap.marmolata.react.impls.selfrx.debugger.Debugger
import com.sap.marmolata.react.impls.selfrx.{Observable, Primitive}
import Debugger._
import com.sap.marmolata.react.impls.selfrx.debugger.JavaScriptFunctions.NodeProperties
import com.sap.marmolata.react.impls.selfrx.debugger.updatelogger.RecordingLogUpdates
import com.sap.marmolata.react.impls.selfrx.debugger.JavaScriptFunctions
...
import com.sap.marmolata.react.api.ReactiveLibrary.InternalAnnotation
import com.sap.marmolata.react.debug.{AnnotateStack, InternalStrictMap}
...
case class TreeDefinition(name: String, prims: Seq[Primitive], showFiles: ShowFiles, showTags: ShowTags) {
  def currentlySelected: Seq[com.sap.marmolata.react.impls.selfrx.debugger.visualization.GraphNode] = {
