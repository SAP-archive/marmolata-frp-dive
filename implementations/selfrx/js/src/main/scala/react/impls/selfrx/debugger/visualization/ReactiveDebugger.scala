...
import react.impls.selfrx
import react.impls.selfrx.debugger.Debugger
import react.impls.selfrx.{Observable, Primitive}
import Debugger._
import react.impls.selfrx.debugger.JavaScriptFunctions.NodeProperties
import react.impls.selfrx.debugger.updatelogger.RecordingLogUpdates
import react.impls.selfrx.debugger.JavaScriptFunctions
...
case class TreeDefinition(name: String, prims: Seq[Primitive], showFiles: ShowFiles, showTags: ShowTags) {
  def currentlySelected: Seq[react.impls.selfrx.debugger.visualization.GraphNode] = {
